...
-- Created on Tue Mar 24 22:19:14 2015
-- 
...
CREATE TABLE users (
  ...
  disp_nick varchar(50),
  pronoun varchar(5) DEFAULT NULL
);

CREATE UNIQUE INDEX users_disp_nick_idx ON users (disp_nick);
...
CREATE UNIQUE INDEX users_games_hands_user_game_pos_idx ON users_games_hands (user_game, pos);
